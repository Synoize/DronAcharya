...
export const AdminMenu = () => {
    ...
    return (
        <>
            ...
            <NavLink to="/admin/users" style={getActivePage} title="Users" className="flex justify-center items-center sm:justify-start sm:gap-2 p-2 rounded hover:bg-blue-800 "><HiOutlineUser className="text-lg"/><p className="hidden sm:block ">Users</p></NavLink>

            <NavLink to="/admin/contacts" style={getActivePage} title="Contacts" className="flex justify-center items-center sm:justify-start sm:gap-2 p-2 rounded hover:bg-blue-800 "><IoIosContacts className="text-lg"/><p className="hidden sm:block ">Contacts</p></NavLink>
