...
export const Navbar = () => {
  ...
  return (
    <>
      ...
      <NavLink to="/courses/dashboard" style={getActivePage} className="flex gap-2 items-center "><FaLaptopCode />Course</NavLink>
      ...
      {isLoggedIn ? (
        <NavLink to="/logout" style={getActivePage} className="flex gap-2 items-center"><LuUser2 /><span className="text-red-500">Logout</span></NavLink>
      ) : (
