...
export const Home = () => {
    ...
    return <main>
        ...
        <section className="flex flex-col ~gap-8/12 ~p-8/20 bg-black">
            <h2 className="~text-xl/5xl text-primary font-bold">ANYONE CAN BE ANYTHING !!!</h2>
            <div className="flex flex-col sm:flex-row-reverse items-center sm:items-start ~gap-8/12 ">
                <span>
                ...
                <p className="~text-xl/4xl text-primary ">In DronAcharya anyone can be anything, a teacher can be a student a student can be a teacher or vice versa. Learn from teachers are who are passionate in their field to grow and level up yourselves.</p>
            </div>
        </section>

        <section className="flex flex-col ~gap-8/20 ~p-8/20 bg-gradient-to-b from-black to-blue-800 ">
            <h1 className="~text-xl/5xl text-primary font-semibold">TRENDING COURSES.</h1>
