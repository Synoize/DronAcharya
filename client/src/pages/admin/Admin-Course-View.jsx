...
export const AdminCourseView = () => {
    ...
    return <div className="p-6 w-full flex flex-col items-center gap-6 overflow-auto">
        <div className="w-full sm:w-96 flex items-start justify-between">
            <h1 className="font-semibold ~text-lg/xl">Admin View Course Data</h1>
                    ...
                    <div className="border p-2 rounded">
                        ...
                        <div className="flex flex-col justify-between gap-2 p-2 ">
                            ...
                            <div className="flex gap-2">
                                <p className="w-full bg-green-500 font-semibold rounded text-white text-sm flex justify-center items-center">₹ {courseData.price}</p>
                                <button className=" w-full p-2 bg-blue-500 hover:bg-blue-600 rounded text-white ~text-xs/sm">Save</button>
                            </div>
                        </div>
                    </div>
                )
