        ...
        <form onSubmit={handleFormSubmit} className="sm:flex w-full sm:w-96">
            <ul>
                ...
                <li className="border p-2 flex flex-col justify-start">
                    <label htmlFor="password" className="font-semibold text-primary_text text-nowrap">Password <span className="text-primary_special">*</span></label>
                ...
                {/* <li className="border border-b-0 p-2 flex flex-col justify-start">
                    <label htmlFor="phoneNumber" className="font-semibold text-primary_text text-nowrap">Phone number</label>
                    <input type="number" name="phoneNumber" id="phoneNumber" className="outline-none font-semibold text-secondary" />
                </li> */}

                <button type="submit" className="w-full mt-4 p-4 bg-primary_special text-primary hover:bg-red-500">Login</button>
            </ul>
        </form>
    </section>
}